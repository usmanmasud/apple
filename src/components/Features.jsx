                            ...
                            <div className="feature-text-container">
                                <div className="flex-1 flex-center">
                                    <p className="feature-text g_text">iPhone 15 Pro is {' '}
                                        ...
                                        using the same alloy that spacecraft uses for Missions to Mars.
                                    </p>
                                </div>

                                <div className="flex-1 flex-center">
                                    <p className="feature-text g_text">Titanium has one of the best strength-to-weight ratios of any meta, making this our {' '}
                                        <span className="text-white">
